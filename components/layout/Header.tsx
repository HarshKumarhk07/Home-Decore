...
export default function Header() {
      ...
      : [
          {
            ...
            subcategories: settings?.waterproofingSubcategories || [],
          },
          {
            name: "Wooden Flooring",
            href: "/services/wooden-flooring",
            subcategories: settings?.flooringSubcategories || [],
          },
          {
            name: "PVC (Polyvinyl Chloride)",
            href: "/services/pvc",
            subcategories: settings?.pvcSubcategories || [],
          },
        ];
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const { getSettings, getServiceCategories } =
          await import("@/actions/cmsActions");
        ...
        <div className="flex items-center justify-between">
                ...
                <div className="py-1 divide-y divide-slate-100">
                  {servicesList.map((service) => {
                    ...
                    return (
                      <div
                        key={service.name}
                        className="py-2 first:pt-0 last:pb-0 px-1"
                      >
                        <Link
                          href={service.href}
          ...
          <div className="hidden lg:flex items-center space-x-5">
            ...
            >
              ...
              <span className="font-bold">+91 82955 24045</span>
            </Link>
            <Button
              asChild
              className="bg-gradient-to-r from-primary to-blue-700 hover:from-blue-700 hover:to-primary text-white font-bold shadow-[0_4px_14px_rgba(30,64,175,0.25)] hover:shadow-[0_4px_20px_rgba(30,64,175,0.35)] hover:-translate-y-0.5 active:translate-y-0 rounded-xl px-5 py-2.5 transition-all duration-300 cursor-pointer"
            >
        ...
        <div className="px-4 pt-2 pb-6 space-y-2">
          ...
          <div className="space-y-1">
            ...
            >
              <span>Services</span>
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-200 ${activeDropdown ? "rotate-180" : ""}`}
              />
            </button>
            <div
              className={`pl-4 space-y-1 transition-all duration-300 overflow-hidden ${activeDropdown ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"}`}
            >
              {servicesList.map((service) => {
                const subList = service.subcategories;
          ...
          <div className="pt-4 border-t border-gray-100 space-y-3">
            ...
            >
              ...
              <span>+91 82955 24045</span>
            </Link>
            <div className="px-3">
              <Button
                asChild
                className="w-full bg-primary hover:bg-primary-hover text-white rounded-xl py-3 font-semibold shadow-md"
              >
                <Link href="/quote">Get Free Quote</Link>
              </Button>
            </div>
