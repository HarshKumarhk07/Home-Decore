      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-slate-600 text-sm sm:text-base">
            Reach out to our project division or head office regarding site inspections, sample kits, and quotations.
          </p>
        </div>
            ...
            <ul className="space-y-6 text-sm sm:text-base">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-800 mt-0.5">Plot 42, Sector 62, Noida, Uttar Pradesh, India - 201301</p>
                </div>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-800 mt-0.5">
                    <a href="mailto:info@homedecorater.in" className="hover:text-primary transition-colors">info@homedecorater.in</a>
                  </p>
                </div>
              </li>
              <li className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-800 mt-0.5">Mon - Sat: 9:00 AM - 6:30 PM</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative h-[300px] sm:h-[450px] rounded-none overflow-hidden shadow-sm border border-slate-200">
            <iframe
              ...
              title="Home Decorater Sector 62 Office Location"
            ></iframe>
          </div>
        </div>
      </div>
