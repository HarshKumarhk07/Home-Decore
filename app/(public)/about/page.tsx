    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[300px] sm:h-[400px] rounded-3xl overflow-hidden shadow-lg border border-slate-100">
            <Image
        ...
        {/* Stats */}
        <div className="bg-primary text-white rounded-3xl p-8 sm:p-10 shadow-md">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {coreValues.map((value, idx) => (
              <div key={idx} className="bg-white border border-slate-100 p-6 sm:p-8 rounded-2xl shadow-sm text-center space-y-4">
                <div className="p-3 bg-primary-light rounded-2xl text-primary w-fit mx-auto">
                  {value.icon}
                </div>
        ...
        {/* Direct Connect CTA */}
        <div className="bg-white border border-slate-150 rounded-3xl p-8 sm:p-12 text-center max-w-4xl mx-auto shadow-sm space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Button asChild className="bg-primary hover:bg-primary-hover text-white rounded-xl px-8 py-6 font-bold shadow-md">
              <Link href="/inspection">Book Free Site Visit</Link>
            </Button>
            <Button asChild variant="outline" className="border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl px-8 py-6 font-bold">
