export const metadata = {
  ...
  description: "Read the service terms, inspection parameters, and structural warranty conditions of Homes Decorator.",
    ...
    <div className="bg-slate-50 min-h-screen py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 bg-white border border-slate-100 rounded-3xl p-8 sm:p-12 shadow-sm space-y-6 text-slate-700">
        ...
        <p className="text-sm leading-relaxed">
          Welcome to Homes Decorator. By requesting a service quotation or booking a site moisture inspection, you agree to comply with and be bound by the following terms and conditions.
        </p>
